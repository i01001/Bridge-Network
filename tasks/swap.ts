...
.addParam("fromtoken", "Contract address from which tokens will be transferred")
...
.setAction(async (taskArgs,hre) => {
  ...
  let output = await bridgeContract.connect(sender).swap(taskArgs.fromtoken, taskArgs.totoken,taskArgs.amount, taskArgs.tochainID);
